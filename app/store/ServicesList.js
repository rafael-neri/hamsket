Ext.define('Rambox.store.ServicesList', {
	...
	,data: [
		...
		},
		{
			...
			,type: 'messaging'
			,js_unread: `let checkUnread=()=>{const e=document.getElementsByClassName("hc-badge");let t=0;for(let i in e)t+=parseInt((e[i].innerHTML || '0').trim());rambox.updateBadge(t)};setInterval(checkUnread,3e3);`
			,custom_domain: true
		},
		{
			 id: 'telegram'
